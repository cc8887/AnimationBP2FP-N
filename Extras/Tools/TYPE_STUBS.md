...
- **缓存**（2 个）：save-cached-pose、use-cached-pose
...
| 文件 | 作用 | 状态 |
|------|------|------|
| `animlang-types.rkt` | 基础类型定义 (含 RefExpr) | ✅ 已更新 (2026-03-25) |
| `animlang-nodes.rkt` | 节点库 (25 个，匹配导出格式) | ✅ 已更新 (2026-03-25) |
